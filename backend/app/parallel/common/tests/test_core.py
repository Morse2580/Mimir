...
class TestBelgianRRNDetection:
    ...
    def test_valid_rrn_patterns(self):
        ...
        for text in test_cases:
            ...
            assert any(
                m.pattern_type == "belgian_rrn" for m in matches
            ), f"Should identify as Belgian RRN: {text}"
    ...
    def test_rrn_validation_logic(self):
        ...
        assert _validate_belgian_rrn(
            "00010100105"
        )  # Valid 2000 birth (corrected checksum)
...
class TestBelgianVATDetection:
    ...
    def test_valid_vat_patterns(self):
        ...
        for text in test_cases:
            ...
            assert any(
                m.pattern_type == "belgian_vat" for m in matches
            ), f"Should identify as Belgian VAT: {text}"
...
class TestIBANDetection:
    ...
    def test_valid_iban_patterns(self):
        ...
        for text in test_cases:
            ...
            assert any(
                m.pattern_type == "iban" for m in matches
            ), f"Should identify as IBAN: {text}"
...
class TestEmailDetection:
    ...
    def test_valid_email_patterns(self):
        ...
        for text in test_cases:
            ...
            assert any(
                m.pattern_type == "email" for m in matches
            ), f"Should identify as email: {text}"
...
class TestPhoneDetection:
    ...
    def test_belgian_phone_patterns(self):
        ...
        for text in test_cases:
            ...
            assert any(
                m.pattern_type == "phone" for m in matches
            ), f"Should identify as phone: {text}"
...
class TestCreditCardDetection:
    ...
    def test_valid_credit_card_patterns(self):
        ...
        for text in test_cases:
            ...
            assert any(
                m.pattern_type == "credit_card" for m in matches
            ), f"Should identify as credit card: {text}"
...
class TestPIIAttackVectors:
    ...
    def test_attack_vector_4_context_injection(self):
        ...
        malicious_data = {
            ...
            "metadata": {"phone": "+32 2 123 45 67"},
        }

        risk_score = calculate_risk_score(malicious_data)
        assert (
            risk_score > 0.7
        ), f"Should detect high risk in structured data, got {risk_score}"
    ...
    def test_attack_vector_5_large_payload_with_embedded_pii(self):
        ...
        assert (
            risk_score > 0.5
        ), f"Should show elevated risk for large payload with PII, got {risk_score}"
...
class TestRiskCalculation:
    ...
    def test_pii_data_high_risk(self):
        ...
        pii_data = {"user_email": "john@company.com", "iban": "BE62510007547061"}
    ...
    def test_large_payload_moderate_risk(self):
        ...
        large_data = {"content": "This is a very long document. " * 200}  # ~6000 chars

        risk_score = calculate_risk_score(large_data)
        assert (
            0.1 < risk_score < 0.4
        ), f"Large payload should have moderate risk, got {risk_score}"
    ...
    def test_sensitive_keywords_risk(self):
        ...
        assert (
            risk_score > 0.3
        ), f"Sensitive keywords should increase risk, got {risk_score}"
...
class TestPerformanceRequirements:
    ...
    def test_pii_detection_performance(self):
        ...
        """
            * 10
        )  # Multiply to create larger test
        ...
        assert (
            execution_time < 50
        ), f"PII detection took {execution_time}ms (limit: 50ms)"
