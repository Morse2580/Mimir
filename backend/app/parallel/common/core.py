...
def _validate_belgian_rrn(rrn: str) -> bool:
    ...
    if year < 50:  # Assume 20xx
        ...
        return check_digits == (97 - remainder_19) or check_digits == (97 - remainder_20)
    else:  # Assume 19xx
...
def calculate_risk_score(data: dict) -> float:
    ...
    sensitive_keywords = [
        ...
        'confidential', 'ssn', 'social', 'account', 'credit'
    ]
    keyword_matches = sum(1 for keyword in sensitive_keywords 
                         if keyword.lower() in text_content.lower())
    keyword_risk = min(1.0, keyword_matches / 3.0)  # Scale by fewer keywords for higher impact
